...
public class VoteCountSearchAdapter extends RecyclerView.Adapter<VoteCountSearchAdapter.ViewHolder>{
    ...
    public VoteCountSearchAdapter(Context context, String type, List<Genres> genresList, String title, SecondCollectListener secondCollectListener) {
