...
public class VotePointSearchAdapter extends RecyclerView.Adapter<VotePointSearchAdapter.ViewHolder>{
    ...
    public VotePointSearchAdapter(Context context, String type, List<Genres> genresList, String title, SecondCollectListener secondCollectListener) {
