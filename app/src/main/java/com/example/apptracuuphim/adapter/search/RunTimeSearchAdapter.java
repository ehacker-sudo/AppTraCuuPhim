...
public class RunTimeSearchAdapter extends RecyclerView.Adapter<RunTimeSearchAdapter.ViewHolder>{
    ...
    public RunTimeSearchAdapter(Context context, String type, List<Genres> genresList, String title, SecondCollectListener secondCollectListener) {
